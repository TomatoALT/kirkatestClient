...
async function autoUpdate(contents) {
    return new Promise((resolve, reject) => {
        contents.on('dom-ready', async () => {
            ...
            let res = await fetch('https://github.com/TomatoALT/kirkatestClient/releases/latest/download/version.txt')
...
async function downloadUpdate(contents) {
    ...
    const pUrl = "https://api.github.com/repos/TomatoALT/kirkatestClient/releases";
